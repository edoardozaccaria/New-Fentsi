        ...
        return (
          ...
          >
            <CardContent className="space-y-3 p-6">
              ...
              <div className="h-20 rounded-2xl bg-accent-gradient" />
    ...
    <div className="grid gap-3 md:grid-cols-2">
      {extrasOptions.map((extra) => {
        ...
        return (
          ...
          >
            <span className="text-sm font-medium text-slate-900">{extra.label}</span>
          </Button>
        );
      })}
    </div>
...
function ConsentStep({ draft, setConsent, onGenerate, isGenerating }: RenderStepParams) {
  return (
    <div className="space-y-6">
