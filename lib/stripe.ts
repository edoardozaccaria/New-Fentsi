...
// Lazy — not instantiated at module level (would crash Next.js build without env vars)
...
export const PLANS = {
  single: {
    ...
    eventsLimit: 1,
    oneTime: false,   // monthly subscription
  },
  pro: {
    name: 'Pro',
    price: 29,
...
export const ONE_TIME_PRODUCTS = {
  coordination: {
    ...
    description: 'Il team Fentsi gestisce trattative, contratti e conferme con tutti i fornitori selezionati',
  },
} as const
